...
<%@page import="com.nandhini.matrimonyapp.domain.Profiles"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1"%>
<%@include file="header.jsp"%>
<%@ page import="com.nandhini.matrimonyapp.dao.impl.ProfilesImpl"%>
<%@ page import="com.nandhini.matrimonyapp.dao.ProfilesInterfaceDAO"%>
...
<body>
	<div>
		<form>
			...
			<table align="left" cellpadding="7">
				...
				<tr>
					<td><h3>Enter Occupation(not in):</h3></td>
					<td><input type="text" name="occupation" required /></td>
				</tr>

				<tr>
					<td align="right"><input type="submit" name="occupation"
						value="submit">
					<td>
				</tr>
			</table>
	...
	<%
		List<Profiles> d = new ArrayList<Profiles>();
			...
			try {
		d = p.findByNotInOccupation(gender, occupation);
			} catch (Exception e) {
		e.printStackTrace();
			}
		...
		out.print("<tr><td>" + pi.getUserName() + "</td><td><img src=images/" + pi.getPic()
				+ " height='100' width='100'> </td><td>" + pi.getDob() + "</td><td>" + pi.getGender()
				+ "</td><td>" + pi.getReligion() + "</td><td>" + pi.getCaste() + "</td><td>" + pi.getCountry()
				+ "</td><td>" + pi.getState() + "</td><td>" + pi.getCity() + "</td><td>" + pi.getMobNo()
				+ "</td><td>" + pi.getHeight() + "</td><td>" + pi.getEducation() + "</td><td>"
				+ pi.getOccupation() + "</td><td>" + pi.getMaritalSts() + "</td><td>" + pi.getSalary()
				+ "</td><td><a href=SendRequest.jsp?mail=" + pi.getMail() + ">Request</a></td></tr>");
		out.print("<br>");
			}
