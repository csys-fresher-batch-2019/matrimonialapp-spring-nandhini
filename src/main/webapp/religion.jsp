...
<div>
<form>
<h1>Display Profile as per their Religion</h1>
...
<tr>
<td align="right">
<input type="submit" name="religion" value="submit" >
<td>
</tr>
</table>
</form>
...
String religion=request.getParameter("religion");
 ...
 try {
		d=p.findByReligion(gender,religion);
 }		
catch(Exception e)
{
	e.printStackTrace();
...
for (ProfilesImpl pi : d) {
	System.out.println(pi.findByReligion(gender,religion));
